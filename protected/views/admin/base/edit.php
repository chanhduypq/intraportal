...
<div class="wrap admin secondary base">
    ...
    <div class="container">
        <div class="contents detail">
            ...
            <div class="mainBox">
            	<div class="pageTtl"><h2>部署管理 > 部署修正</h2></h2>
                    <span><a href="<?php echo Yii::app()->request->baseUrl; ?>/adminbase/unit/?base_id=<?php if(isset($base_id)) echo $base_id;?>" class="btn btn-important"><i class="icon-chevron-left icon-white"></i> 部署一覧に戻る</a></span></div>
                <div class="box">
                    ...
                    <div class="cnt-box">
                     <p class="descriptionTxt">部署&amp;メンバー紹介ページと、マジメのポータルトップページの今週の部署紹介に反映されます。</p>
                        ...
                        <div class="baseDetailBox">
							...
							$attachements->edit11($model, $form,'adminbase',$attachment1_error,$attachment2_error,$attachment3_error,$this->assetsBase);                        
							$this->endWidget();
							?>
                            </div><!-- /taxtBox -->
                        </div><!-- /baseDetailBox -->
...
<script type="text/javascript"> 
        ...
        jQuery(function($){
         ...
         $("#unit_form").attr('action','<?php echo Yii::app()->baseUrl;?>/adminbase/editconfirm/?base_id=<?php echo $_GET['base_id']?>&id=<?php echo $model->id;?>');        
            
			//check back browser 
		   unit_branch_id=getCookie("unit_edit_branch_id");
		   ...
		   unit_office_id=getCookie("unit_edit_office_id");
           ...
           unit_tel=getCookie("unit_edit_tel_number");
           if(unit_tel!=null&&unit_tel!="null")
		   {
               $("#Unit_tel_number").val(unit_tel);
           }
   unit_edit_cancel_random=getCookie("unit_edit_cancel_random");
           if(unit_edit_cancel_random!=null&&unit_edit_cancel_random!="null"){
		   if(unit_edit_cancel_random=='1'){
           ...
           $('button[type="submit"]').click(function(){ 
			...
			$.ajax({    
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/adminbase/edit/?base_id=<?php echo $_GET['base_id']?>&id=<?php echo $model->id?>",    
				...
				{	     
					  ...
					  {   
					   	   setCookie("unit_edit_branch_id",$("#Unit_branch_id").val());
						   setCookie("unit_edit_office_id",$("#Unit_office_id").val());	
                           setCookie("unit_edit_unit_name",$("#Unit_unit_name").val());
                           setCookie("unit_edit_mailaddr",$("#Unit_mailaddr").val());
                           setCookie("unit_edit_tel_number",$("#Unit_tel_number").val());
						   ...
						   setCookie("unit_edit_introduction",val);
							...
							if($("#Unit_attachment3_checkbox_for_deleting").attr('checked')==true){
								...
								setCookie("unit_edit_attachment3_checkbox_for_deleting",'0');
                                    ...
                                    setCookie("unit_edit_cancel_random",'1');
                            }
                            else{
                                    setCookie("unit_edit_cancel_random",'0');
                            }
