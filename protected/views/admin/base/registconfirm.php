...
<div class="wrap admin secondary base">
    ...
    <div class="container">
        <div class="contents detail">
            ...
            <div class="mainBox">
            	<div class="pageTtl"><h2>部署管理 > 部署登録確認</h2></div>
                <div class="box">
                    ...
                    $form = $this->beginWidget('CActiveForm', array(
                        'id' => 'unit_form',
                        'htmlOptions' => array('enctype' => 'multipart/form-data', 'action' => Yii::app()->baseUrl . '/adminbase/registconfirm'),
                    ));
                    ?>
                            ...
                            <div class="textBox clearfix">
                                ...
                                <div class="attachements">
                                  <?php
                                    ...
                                    $attachements->registConfirm11($model, $form, 'adminbase',$this->assetsBase);
                                    $this->endWidget();
                                    ?>
                                </div><!-- /attachements -->
...
<script type="text/javascript">
    jQuery(function($) {
        ...
        $('button#back').click(function() {
            ...
            window.location = "<?php echo Yii::app()->baseUrl; ?>/adminbase/regist/?base_id=<?php echo $_GET['base_id']?>";
        });
        $('a').click(function() {
            img=$(this).find('img');
