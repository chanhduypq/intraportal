        ...
        <div class="contents regist">        	
            <div class="mainBox detail">
            	<div class="pageTtl">
					...
					?>
                    <span>
                        <a class="btn btn-important" href="<?php echo Yii::app()->request->baseUrl; ?>/adminshare_item/<?php echo $page;?>">
                    ...
                    <div class="control-group">
                      ...
                      <div class="field attachements">
                        ...
                        $attachements = $this->beginWidget('ext.helpers.Form_new');
                            $attachements->regist11($model, $form,$attachment1_error,$attachment2_error,$attachment3_error,'adminshare_item',$this->assetsBase);
                            $this->endWidget();
                            ?>
...
<script type="text/javascript"> 
        ...
        $('input[type="checkbox"]').click (function (){            
           ...
           $("#share_item_form").attr('action','<?php echo Yii::app()->baseUrl;?>/adminshare_item/registconfirm/');          
           title=getCookie("share_item_regist_title");
           ...
           content=getCookie("share_item_regist_content");           
           if(content!=null&&content!="null"){
              content1=content.replace(/<br ?\/?>|_/g, '\n');    
               $("#Share_item_content").val(content1);
           }
           attachment1_checkbox_for_deleting=getCookie("share_item_regist_attachment1_checkbox_for_deleting");
           ...
           attachment2_checkbox_for_deleting=getCookie("share_item_regist_attachment2_checkbox_for_deleting");
           ...
           attachment3_checkbox_for_deleting=getCookie("share_item_regist_attachment3_checkbox_for_deleting");
           ...
           setCookie("share_item_regist_content",content); 
            /**
             * 
             */
           $("body").attr('id','admin');      
           ...
           $('button[type="submit"]').click(function(){  
			...
			$.ajax({    
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/adminshare_item/regist/",    
				...
				success: function(msg){	                        					  		
					  ...
					  jQuery('#Share_item_content').prev().remove();                                       						                               					  	
					  	if(msg!='[]'|checkFile()==false){
                                                ...
                                                val=val.replace(/\n/g, "<br/>");
                                                setCookie("share_item_regist_content",val);
                                                if($("#Share_item_attachment1_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("share_item_regist_attachment1_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("share_item_regist_attachment1_checkbox_for_deleting",'0');
                                                }
                                                if($("#Share_item_attachment2_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("share_item_regist_attachment2_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("share_item_regist_attachment2_checkbox_for_deleting",'0');
                                                }
                                                if($("#Share_item_attachment3_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("share_item_regist_attachment3_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("share_item_regist_attachment3_checkbox_for_deleting",'0');
                                                }
