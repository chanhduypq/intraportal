...
{         
	...
	{   
		...
		$.ajax({    
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/admincategory/categoryregist/?type=4",    
				data: jQuery('#skill_cat_regist').serialize(),
				...
				{	     
					  ...
					  {   
							...
							if(r==true)
							{
//								jQuery('#skill_cat_regist').attr('onsubmit','return true;');
								jQuery('#skill_cat_regist').submit();
							}
					  }					    			    
				 }	  
			});
