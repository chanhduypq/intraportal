    ...
    <div class="container">
        <div class="contents regist">
            ...
            <div class="mainBox detail">
            	<div class="pageTtl">
					<h2>資格取得・スキルアップ！ - カテゴリー - 修正</h2>
				    <span>
					   <?php if(Yii::app()->request->cookies['page'] >'1'): ?>	
						   <a href="<?php echo Yii::app()->request->baseUrl; ?>/admincategory/categories/?page=<?php echo Yii::app()->request->cookies['page']?>&type=4" class="btn btn-important">
	...
	function checkId(id)
	{
		...
		$.ajax({   
			...
			{	  
				if(msg=='0')
				{ 
					window.location.href="<?php echo Yii::app()->baseUrl;?>/admincategory/categories/?type=4";
				}
			}
		});
	}
	...
	{         
		...
		{   
			...
			$.ajax({    
					type: "POST", 
					async:true,
					url: "<?php echo Yii::app()->baseUrl;?>/admincategory/categoryedit/?type=4",    
					data: jQuery('#skill_cat_edit').serialize(),
					success: function(msg)
					{	     
						  ...
						  {   
								...
								if(r==true)
								{
//									jQuery('#skill_cat_edit').attr('onsubmit','return true;');
									jQuery('#skill_cat_edit').submit();
								}
						  }					    			    
					 }	  
				});
