    ...
    <div class="container">
        <div class="contents detail">
            <div class="mainBox detail">
                <div class="pageTtl"><h2>トラブル＆不正情報 - 詳細</h2>
					<?php 
                    ...
                    <span>
						...
						<i class="icon-chevron-left icon-white"></i> 一覧に戻る</a>
					</span>
                    <span><a class="btn btn-work" href="<?php echo Yii::app()->request->baseUrl; ?>/admintrouble/edit/?id=<?php echo $model->id;?>"><i class="icon-pencil icon-white"></i> 修正</a></span>
                </div>
                <div class="box">
                    ...
                    $attachements->detail($model, 'admintrouble',$this->assetsBase,$edit=true);                        
                    $this->endWidget();
                    ?>                  
...
?>
    <a <?php if (in_array($host_file_attachment_ext, $img_extention_array)) echo ' rel="prettyPhoto" '; ?> 
        href="<?php echo Yii::app()->request->baseUrl; ?>/admintrouble/download/?id=<?php echo $model->id."&".$order_index; ?>">
