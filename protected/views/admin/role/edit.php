    ...
    <div class="container">
        <div class="contents index">
            ...
            <div class="mainBox detail">
            	<div class="pageTtl"><h2>役割管理 - 修正</h2>
                <span><a href="<?php echo Yii::app()->baseUrl.'/adminrole/'?>" class="btn btn-important"><i class="icon-chevron-left icon-white"></i> 一覧に戻る</a></span>
                </div>
                <div class="box">
                                    ...
                                    <div class="controls">
                                        <div>
                                            ...
                                            <?php     }
											   ...
											   <span class="ico view">閲覧</span></label>
                                            <?php    } ?>
                                            <?php
                                            if(strcmp(trim($function->function_name),"今月の社員ピックアップ")==0 || (strcmp(trim($function->function_name),"Twitterキャッチ！")==0) 
                                              ...
                                              || (strcmp(trim($function->function_name),"事業所管理")==0) || (strcmp(trim($function->function_name),"タグクラウド設定")==0)
                                                ...
                                                <label class="checkbox inline"><input name="Role_management[<?php echo $i ?>][chkpost]"
                                                                                  name="" type="checkbox" id="chbpost_<?php echo $i ?>" disabled="disabled" <?php echo $checkPost ?>/><span
                                                    class="ico posts_off">投稿</span></label>
                                            <?php     }
                                            else { ?>
                                                 <label class="checkbox inline"><input name="Role_management[<?php echo $i ?>][chkpost]"
                                                                                  name="" type="checkbox" id="chbpost_<?php echo $i ?>" <?php echo $checkPost ?>/><span
                                            ...
                                            <label class="checkbox inline"><input
                                                    name="Role_management[<?php echo $i ?>][chkadmin]" type="checkbox" id="chbadmin_<?php echo $i ?>" disabled="disabled" <?php echo $checkAdmin ?>/><span
                                                    class="ico control_off">管理</span></label>
                                            <?php }
                                            else{?>
                                                 <label class="checkbox inline"><input
                                                    name="Role_management[<?php echo $i ?>][chkadmin]" type="checkbox" id="chbadmin_<?php echo $i ?>" <?php echo $checkAdmin ?>/><span
