  ...
  <div class="container">
    <div class="contents regist">
      <div class="mainBox detail">
        <div class="pageTtl">
          <h2>ゴルフもマジメ！  - カテゴリー - 修正</h2>
          <span>
		   <?php if(Yii::app()->request->cookies['page'] >'1'): ?>	
			   <a href="<?php echo Yii::app()->request->baseUrl; ?>/admincategory/categories/?page=<?php echo Yii::app()->request->cookies['page']?>&type=5" class="btn btn-important">
	...
	function checkId(id)
	{
		...
		$.ajax({   
			...
			{	        
				if(msg=='0')
				{ 
					window.location.href="<?php echo Yii::app()->baseUrl;?>/admincategory/index/?type=5";
				}
			}
		});
	}
	...
	{         
		...
		{   
			...
			$.ajax({    
					type: "POST", 
					async:true,
					url: "<?php echo Yii::app()->baseUrl;?>/admincategory/categoryedit/?type=5",    
					data: jQuery('#golf_news_cat_edit').serialize(),
					success: function(msg)
					{	     
						  ...
						  {   
								...
								if(r==true)
								{
//									jQuery('#golf_news_cat_edit').attr('onsubmit','return true;');
									jQuery('#golf_news_cat_edit').submit();
								}
						  }					    			    
					 }	  
				});
