    ...
    <div class="container">
        <div class="contents edit">
            ...
            <div class="mainBox detail">
            	<div class="pageTtl"><h2>ゴルフもマジメ！ - 修正</h2>
                ...
                <div class="cnt-box">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls photo">
                            <div id="error_message4"></div>                                    
                                    ...
                                    $attachement4->edit14($model, $form,'admingolf_news',$attachment4_error,$this->assetsBase);                        
                                    $this->endWidget();
                                    ?>
					...
					<div class="field attachements">
						<?php                    
                                                ...
                                                $attachements->edit11($model, $form,'admingolf_news',$attachment1_error,$attachment2_error,$attachment3_error,$this->assetsBase);                        
                                                $this->endWidget();
                                                ?>
					</div>
...
function checkId()
{
        ...
        type: "POST", 
                ...
                success: function(msg){	
                        ...
                        if(msg=='0'){ 
                                window.location='<?php echo Yii::app()->baseUrl;?>/admingolf_news';
                        }
                }
        });
}
...
$('input[type="checkbox"]').click (function (){            
   ...
   $("body").attr('id','admin');    
   $("#golf_news_form").attr('action','<?php echo Yii::app()->baseUrl;?>/admingolf_news/editconfirm/'); 
   title=getCookie("golf_news_edit_title");          
   ...
   content=getCookie("golf_news_edit_content");           
   ...
   category_id=getCookie("golf_news_edit_category_id");   
   ...
   attachment1_checkbox_for_deleting=getCookie("golf_news_edit_attachment1_checkbox_for_deleting");
   if(attachment1_checkbox_for_deleting!=null&&attachment1_checkbox_for_deleting!="null"){              
       if(attachment1_checkbox_for_deleting=='1'){
           ...
           $fileInput=$("#Golfnews_attachment1_checkbox_for_deleting").parent().parent().prev().find('input[type="file"]').eq(0);
                  name=$fileInput.attr('name');
                  id=$fileInput.attr('id');
                  classAttr=$fileInput.attr('class');
                  ...
                  $fileInput.replaceWith("<input type='file' name='"+name+"' id='"+id+"' class='"+classAttr+"'/>");
                  //
                  $node1=$("#Golfnews_attachment1_checkbox_for_deleting").parent().parent().prev().prev();
                  $node1.remove();
                  $('<img alt="" src="<?php echo $this->assetsBase; ?>/css/common/img/img_photo01.jpg">').insertBefore($("#Golfnews_attachment1_checkbox_for_deleting").parent().parent().prev());
       }
       else{
   ...
   attachment2_checkbox_for_deleting=getCookie("golf_news_edit_attachment2_checkbox_for_deleting");
   if(attachment2_checkbox_for_deleting!=null&&attachment2_checkbox_for_deleting!="null"){
       if(attachment2_checkbox_for_deleting=='1'){
           ...
           $fileInput=$("#Golfnews_attachment2_checkbox_for_deleting").parent().parent().prev().find('input[type="file"]').eq(0);
                  name=$fileInput.attr('name');
                  id=$fileInput.attr('id');
                  classAttr=$fileInput.attr('class');
                  ...
                  $fileInput.replaceWith("<input type='file' name='"+name+"' id='"+id+"' class='"+classAttr+"'/>");
                  //
                  $node1=$("#Golfnews_attachment2_checkbox_for_deleting").parent().parent().prev().prev();
                  $node1.remove();
                  $('<img alt="" src="<?php echo $this->assetsBase; ?>/css/common/img/img_photo01.jpg">').insertBefore($("#Golfnews_attachment2_checkbox_for_deleting").parent().parent().prev());
       }
       else{
   ...
   attachment3_checkbox_for_deleting=getCookie("golf_news_edit_attachment3_checkbox_for_deleting");
   if(attachment3_checkbox_for_deleting!=null&&attachment3_checkbox_for_deleting!="null"){
       if(attachment3_checkbox_for_deleting=='1'){
           ...
           $fileInput=$("#Golfnews_attachment3_checkbox_for_deleting").parent().parent().prev().find('input[type="file"]').eq(0);
                  name=$fileInput.attr('name');
                  id=$fileInput.attr('id');
                  classAttr=$fileInput.attr('class');
                  ...
                  $fileInput.replaceWith("<input type='file' name='"+name+"' id='"+id+"' class='"+classAttr+"'/>");
                  //
                  $node1=$("#Golfnews_attachment3_checkbox_for_deleting").parent().parent().prev().prev();
                  $node1.remove();
                  $('<img alt="" src="<?php echo $this->assetsBase; ?>/css/common/img/img_photo01.jpg">').insertBefore($("#Golfnews_attachment3_checkbox_for_deleting").parent().parent().prev());
       }
       else{
   ...
   attachment4_checkbox_for_deleting=getCookie("golf_news_edit_eye_catch_checkbox_for_deleting");
   if(attachment4_checkbox_for_deleting!=null&&attachment4_checkbox_for_deleting!="null"){
       if(attachment4_checkbox_for_deleting=='1'){
           $("#Golfnews_eye_catch_checkbox_for_deleting").attr('checked',true);
           $fileInput=$("#Golfnews_eye_catch_checkbox_for_deleting").parent().parent().prev().find('input[type="file"]').eq(0);
                  name=$fileInput.attr('name');
                  id=$fileInput.attr('id');
                  classAttr=$fileInput.attr('class');
                  ...
                  $fileInput.replaceWith("<input type='file' name='"+name+"' id='"+id+"' class='"+classAttr+"'/>");
                  //
                  $node1=$("#Golfnews_eye_catch_checkbox_for_deleting").parent().parent().prev().prev();
                  $node1.remove();
                  $('<img alt="" src="<?php echo $this->assetsBase; ?>/css/common/img/img_photo01.jpg">').insertBefore($("#Golfnews_eye_catch_checkbox_for_deleting").parent().parent().prev());
       }
       else{
   ...
   setCookie("golf_news_edit_content",content);
   $('button[type="submit"]').click(function(){ 
            deleteCookies("golf_news_edit_from"); 		   
			$.ajax({    
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/admingolf_news/edit/?id=<?php echo $model->id;?>",    
				...
				success: function(msg){	                        					  		
					  ...
					  jQuery('#Golfnews_content').prev().remove();      
					  	...
					  	if(msg!='[]'|checkFile()==false){
                                                ...
                                                val=val.replace(/\n/g, "<br/>");
                                                setCookie("golf_news_edit_content",val);
                                                
                                                inputs=$("ul#Golfnews_category_id input");
                                                radio=$("#golf_news_form input[type='radio']:checked");
                                                if(radio.length>0){
                                                    category_id=$(radio).val();
                                                setCookie("golf_news_edit_category_id",category_id);
                                                setCookie("golf_news_edit_category_name",$(radio).next().html());
                                               setCookie("golf_news_edit_background_color",$(radio).next().css('background-color'));
                                               setCookie("golf_news_edit_color",$(radio).next().css('color'));
                                                }
                                                
                                                
                                                if($("#Golfnews_attachment1_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("golf_news_edit_attachment1_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("golf_news_edit_attachment1_checkbox_for_deleting",'0');
                                                }
                                                if($("#Golfnews_attachment2_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("golf_news_edit_attachment2_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("golf_news_edit_attachment2_checkbox_for_deleting",'0');
                                                }
                                                if($("#Golfnews_attachment3_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("golf_news_edit_attachment3_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("golf_news_edit_attachment3_checkbox_for_deleting",'0');
                                                }
                                                if($("#Golfnews_eye_catch_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("golf_news_edit_eye_catch_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("golf_news_edit_eye_catch_checkbox_for_deleting",'0');
                                                }
