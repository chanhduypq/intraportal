...
<script type="text/javascript">      
    ...
    jQuery(function($) {   
       ...
       $('textarea').watermark('ブログを検索するキーワードを入力してください。<br/>現在のキーワードと入れ替えになりますので、継続して検索対象とするキーワードも含めて入力してください。', {fallback: false});
       ...
       $('button#next').click(function() {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "<?php echo Yii::app()->baseUrl; ?>/adminblogc/edit/",
                data: jQuery('#blogc_form').serialize(),
                success: function(msg) {
                    ...
                    if (msg != '[]') {
                        ...
                        if(checkKeyword()==true){
                            ...
                            $(div).addClass('alert');
                            $(div).addClass('info');
                            $(div).html("<?php echo Lang::MSG_0053;?>");
                            controlGroupDiv=$('#Twitter_blogc_keyword').parent();
                            $(div).insertBefore($(controlGroupDiv));
                        }
                        else{
                            if(confirm('このキーワードをブログキャッチ！に設定します。')){                                
                                jQuery("#blogc_form").submit();
                            }
                        }
    ...
    <div class="container">
        <div class="contents index">
            ...
            <div class="mainBox detail">
            	<div class="pageTtl"><h2>ブログキャッチ！ - 設定</h2></div>
                ...
                <div class="cnt-box">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">                                
                        	<?php echo $form->textarea($model, 'keyword', array('placeholder' => 'ブログを検索するキーワードを入力してください。', 'class' => 'input-xxlarge', 'rows' => 7)); ?>                                                    	
