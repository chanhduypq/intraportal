    ...
    <div class="container">
        <div class="contents index">
            ...
            <div class="mainBox detail">
            	<div class="pageTtl">
				<h2>懸賞金付き募集コンテンツ - 採用決定 - 確認</h2>
				</div>
                <div class="box">
				<?php $form = $this->beginWidget('CActiveForm', array(
						'id' => 'adoptionaddconfirm_form',    
						'htmlOptions' => array(
                ...
                <div class="cnt-box">
                    <div class="control-group">
                        ...
                        <div class="controls">
                        	<p class="text">
        						<?php echo nl2br(FunctionCommon::url_henkan($model->adopted_comment));?>	
                        	</p>
                        </div>
                    </div>
...
<script type="text/javascript"> 
	...
	{     
		...
		{
            setCookie("adoption_reg_form","confirm"); 
        }); 
	...
	function submit()
	{
        ...
        jQuery("form#adoptionaddconfirm_form").attr('action','<?php echo Yii::app()->baseUrl;?>/adminbountyapply/adoptionaddconfirm/');
        jQuery("form#adoptionaddconfirm_form").submit();
    }
	function back()
	{      
		setCookie("adoption_reg_form","confirm");   
        jQuery("input#edit").val('0');        			 
        jQuery("form#adoptionaddconfirm_form").attr('action','<?php echo Yii::app()->request->baseUrl; ?>/adminbountyapply/adoptionadd/?id=<?php echo $model->id; ?>');
        jQuery("form#adoptionaddconfirm_form").submit();
    }
</script>		