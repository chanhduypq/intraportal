        ...
        <div class="box">
            ...
            <div class="cnt-box">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <p class="text">
					<?php echo nl2br(FunctionCommon::url_henkan($model->applied_content));?>	
                  </p>
				  <p class="file">
...
<script type="text/javascript">
 	...
 	from=getCookie("adoption_reg_form");        
	if(from=="confirm")
	{
		if(getCookie("adoption_reg_form")!=null && getCookie("adoption_reg_form")!=undefined)
	    {
			deleteCookies("adoption_reg_form");
			window.location="<?php echo Yii::app()->baseUrl;?>/adminbountyapply/adoptionadd/?id=<?php echo $model->id;?>";	
		}
	}
	...
	{ 
			 $("body").attr('id','admin');
			 $("#adoptionadd_form").attr('action', '<?php echo Yii::app()->baseUrl; ?>/adminbountyapply/adoptionaddconfirm/'); 
			 content=getCookie("adopted_reg_comment");
			 ...
			 title=getCookie("adopted_reg_open_type");
			 ...
			 {  
				...
				if(adopted_comment && open_type)
			    {
				   ...
				   val=val.replace(/\n/g, "<br/>");
                   setCookie("adopted_reg_comment",val);
				   setCookie("adopted_reg_open_type",$("#Bounty_apply_open_type").val());
				   jQuery('#adoptionadd_form').submit();
	...
	// {           
		  // $("#adoptionadd_form").attr('action', '<?php echo Yii::app()->baseUrl; ?>/adminbountyapply/adoptionaddconfirm/');  	
		  // // jQuery("#adoptionadd_form").attr('action','<?php echo Yii::app()->baseUrl;?>/adminbountyapply/adoptionaddconfirm');
		   // $("body").attr('id','admin'); 
