...
<script type="text/javascript">
        ...
        from=getCookie("celebrate_regist_from");        
        if(from=="confirm"){
    ...
    jQuery(function($) {
        $("#celebrate_form").attr('action', '<?php echo Yii::app()->baseUrl; ?>/admincelebrate/registconfirm/');                    
        category_id=getCookie("celebrate_regist_category_id");
        record_year=getCookie("celebrate_regist_record_year");
        record_month=getCookie("celebrate_regist_record_month");
        record_day=getCookie("celebrate_regist_record_day");
        base_id=getCookie("celebrate_regist_base_id");
        employee_name=getCookie("celebrate_regist_employee_name");
           ...
           setCookie("celebrate_regist_category_id",category_id);
           setCookie("celebrate_regist_record_year",record_year);
           setCookie("celebrate_regist_record_month",record_month);
           setCookie("celebrate_regist_record_day",record_day);
           setCookie("celebrate_regist_base_id",base_id);
           setCookie("celebrate_regist_employee_name",employee_name);
        ...
        $('button#next').click(function() {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "<?php echo Yii::app()->baseUrl; ?>/admincelebrate/regist/",
    ...
    <div class="container">
        <div class="contents regist">
            ...
            <div class="mainBox detail">
            	<div class="pageTtl"><h2>お祝い - 登録</h2>
