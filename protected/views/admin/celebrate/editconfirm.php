...
<script type="text/javascript">
    jQuery(function($) {
        ...
        setCookie("celebrate_edit_from","confirm");
        });   
       ...
       $('button#submit').click(function(){  
        ...
        $('button#back').click(function(){  
            ...
            window.location="<?php echo Yii::app()->baseUrl;?>/admincelebrate/edit/?id=<?php echo $model->id;?>";
        });
    });
    ...
    <div class="container">
        <div class="contents edit_confirm">
            ...
            <div class="mainBox detail">
            	<div class="pageTtl"><h2>お祝い - 修正 確認</h2></div>
