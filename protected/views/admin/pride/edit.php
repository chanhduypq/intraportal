    ...
    <div class="container">
        <div class="contents edit">
            ...
            <div class="mainBox detail">
            	<div class="pageTtl"><h2>あそびにマジメ！？あそび自慢＆対決！ - 修正</h2>
                <?php 
					...
					?>
                <span><a class="btn btn-important" href="<?php echo Yii::app()->request->baseUrl; ?>/adminpride/<?php echo $page;?>"><i class="icon-chevron-left icon-white"></i> 一覧に戻る</a></span>
                </div>
                <div class="box">
                <?php
                ...
                <div class="cnt-box">
                  ...
                  <div class="field attachements">
                        ...
                        $attachements->edit11($model, $form,'adminpride',$attachment1_error,$attachment2_error,$attachment3_error,$this->assetsBase);
                        $this->endWidget();
                        ?>
...
function checkId()
{
        ...
        type: "POST", 
                async:true,
                url: "<?php echo Yii::app()->baseUrl;?>/adminpride/checkId/",    
                data:{id:"<?php echo $model->id;?>",table:"pride"},
                success: function(msg){	
            
                        
                        if(msg=='0'){ 
                                window.location='<?php echo Yii::app()->baseUrl;?>/adminpride';
                        }
                }
        });
}
        ...
        $('input[type="checkbox"]').click (function (){            
           ...
           $("#pride_form").attr('action', '<?php echo Yii::app()->baseUrl; ?>/adminpride/editconfirm/');   
		   
		   icon=getCookie("pride_edit_icon");
           ...
           title=getCookie("pride_edit_title");
           ...
           content=getCookie("pride_edit_content");
           if(content!=null&&content!="null"){
              content1=content.replace(/<br ?\/?>|_/g, '\n');    
               $("#Pride_content").val(content1);
           }   
           attachment1_checkbox_for_deleting=getCookie("pride_edit_attachment1_checkbox_for_deleting");
           if(attachment1_checkbox_for_deleting!=null&&attachment1_checkbox_for_deleting!="null"){              
               if(attachment1_checkbox_for_deleting=='1'){
                   ...
                   $fileInput=$("#Pride_attachment1_checkbox_for_deleting").parent().parent().prev().find('input[type="file"]').eq(0);
                  name=$fileInput.attr('name');
                  id=$fileInput.attr('id');
                  classAttr=$fileInput.attr('class');
                  ...
                  $fileInput.replaceWith("<input type='file' name='"+name+"' id='"+id+"' class='"+classAttr+"'/>");
                  //
                  $node1=$("#Pride_attachment1_checkbox_for_deleting").parent().parent().prev().prev();
                  $node1.remove();
                  $('<img alt="" src="<?php echo $this->assetsBase; ?>/css/common/img/img_photo01.jpg">').insertBefore($("#Pride_attachment1_checkbox_for_deleting").parent().parent().prev());
               }
               else{
           ...
           attachment2_checkbox_for_deleting=getCookie("pride_edit_attachment2_checkbox_for_deleting");
           if(attachment2_checkbox_for_deleting!=null&&attachment2_checkbox_for_deleting!="null"){
               if(attachment2_checkbox_for_deleting=='1'){
                   ...
                   $fileInput=$("#Pride_attachment2_checkbox_for_deleting").parent().parent().prev().find('input[type="file"]').eq(0);
                  name=$fileInput.attr('name');
                  id=$fileInput.attr('id');
                  classAttr=$fileInput.attr('class');
                  ...
                  $fileInput.replaceWith("<input type='file' name='"+name+"' id='"+id+"' class='"+classAttr+"'/>");
                  //
                  $node1=$("#Pride_attachment2_checkbox_for_deleting").parent().parent().prev().prev();
                  $node1.remove();
                  $('<img alt="" src="<?php echo $this->assetsBase; ?>/css/common/img/img_photo01.jpg">').insertBefore($("#Pride_attachment2_checkbox_for_deleting").parent().parent().prev());
               }
               else{
           ...
           attachment3_checkbox_for_deleting=getCookie("pride_edit_attachment3_checkbox_for_deleting");
           if(attachment3_checkbox_for_deleting!=null&&attachment3_checkbox_for_deleting!="null"){
               if(attachment3_checkbox_for_deleting=='1'){
                   ...
                   $fileInput=$("#Pride_attachment3_checkbox_for_deleting").parent().parent().prev().find('input[type="file"]').eq(0);
                  name=$fileInput.attr('name');
                  id=$fileInput.attr('id');
                  classAttr=$fileInput.attr('class');
                  ...
                  $fileInput.replaceWith("<input type='file' name='"+name+"' id='"+id+"' class='"+classAttr+"'/>");
                  //
                  $node1=$("#Pride_attachment3_checkbox_for_deleting").parent().parent().prev().prev();
                  $node1.remove();
                  $('<img alt="" src="<?php echo $this->assetsBase; ?>/css/common/img/img_photo01.jpg">').insertBefore($("#Pride_attachment3_checkbox_for_deleting").parent().parent().prev());
               }
               else{
           ...
           setCookie("pride_edit_content",content);
           ...
           $('button[type="submit"]').click(function(){  
			...
			$.ajax({ 
				...
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/adminpride/edit/?id=<?php echo $model->id;?>",    
				...
				success: function(msg){	                        
					  ...
					  jQuery('#Pride_content').prev().remove();                                       					
					  	if(msg!='[]'|checkFile()==false){
                                            ...
                                            val=val.replace(/\n/g, "<br/>");
                                            setCookie("pride_edit_content",val);
                                            if($("#Pride_attachment1_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("pride_edit_attachment1_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("pride_edit_attachment1_checkbox_for_deleting",'0');
                                                }
                                                if($("#Pride_attachment2_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("pride_edit_attachment2_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("pride_edit_attachment2_checkbox_for_deleting",'0');
                                                }
                                                if($("#Pride_attachment3_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("pride_edit_attachment3_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("pride_edit_attachment3_checkbox_for_deleting",'0');
                                                }
