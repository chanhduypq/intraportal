    ...
    $('input[type="checkbox"]').click (function (){            
       ...
       $('button#next').click(function() {
            $.ajax({
                type: "POST",
                async: true,
                url: "<?php echo Yii::app()->baseUrl; ?>/admincelebrate_rpt/categoryregist/",
    ...
    <div class="container">
        <div class="contents regist">
            ...
            <div class="mainBox detail">
            	<div class="pageTtl"><h2>お祝い報告 - カテゴリー - 登録</h2>
                    <?php 
        ...
        ?>  削除する
                ...
                <div class="form-last-btn">
                	<p class="btn80">
	                    <button id="next" class="btn btn-important" type="submit"><i class="icon-chevron-right icon-white">&#12288;</i> 登録</button>
                    </p>
                </div>
