    ...
    <div class="container">
        <div class="contents edit">
            ...
            <div class="mainBox detail">
                <div class="pageTtl"><h2>総務からのお知らせ - 修正</h2>
                    <?php
                    ...
                    <span>
                        ...
                        <a href="<?php echo Yii::app()->request->baseUrl; ?>/adminsoumu_news/<?php echo $page; ?>" class="btn btn-important">
                ...
                <div class="box">
                    ...
                    <div class="cnt-box">
                        ...
                        <div class="field attachements">
                            ...
                            $attachements->edit11($model, $form,'adminsoumu_news',$attachment1_error,$attachment2_error,$attachment3_error,$this->assetsBase); 
                            $this->endWidget();
                            ?>
...
function checkId()
{
    jQuery.ajax({
        ...
        data: {id: "<?php echo $model->id; ?>", table: "soumu_news"},
        success: function(msg) {
            if (msg == '0') {
                window.location = '<?php echo Yii::app()->baseUrl; ?>/adminsoumu_news';
            }
        }
    });
}
...
$('input[type="checkbox"]').click (function (){            
        ...
        $("#soumu_news_form").attr('action', '<?php echo Yii::app()->baseUrl; ?>/adminsoumu_news/editconfirm/'); 
        title=getCookie("soumu_news_edit_title");
		   ...
		   label=getCookie("soumu_news_edit_label");
		   if(label!=null&&label!="null"){
			   if(label==1){
				...
				if(label==0){
					 $("#Soumu_news_label").attr("checked", false);  
				} 
           }
           content=getCookie("soumu_news_edit_content");           
           if(content!=null&&content!="null"){
               content1=content.replace(/<br ?\/?>|_/g, '\n');
               $("#Soumu_news_content").val(content1);
           }
           attachment1_checkbox_for_deleting=getCookie("soumu_news_edit_attachment1_checkbox_for_deleting");
           if(attachment1_checkbox_for_deleting!=null&&attachment1_checkbox_for_deleting!="null"){              
               if(attachment1_checkbox_for_deleting=='1'){
                   ...
                   $fileInput=$("#Soumu_news_attachment1_checkbox_for_deleting").parent().parent().prev().find('input[type="file"]').eq(0);
                  name=$fileInput.attr('name');
                  id=$fileInput.attr('id');
                  classAttr=$fileInput.attr('class');
                  ...
                  $fileInput.replaceWith("<input type='file' name='"+name+"' id='"+id+"' class='"+classAttr+"'/>");
                  //
                  $node1=$("#Soumu_news_attachment1_checkbox_for_deleting").parent().parent().prev().prev();
                  $node1.remove();
                  $('<img alt="" src="<?php echo $this->assetsBase; ?>/css/common/img/img_photo01.jpg">').insertBefore($("#Soumu_news_attachment1_checkbox_for_deleting").parent().parent().prev());
               }
               else{
           ...
           attachment2_checkbox_for_deleting=getCookie("soumu_news_edit_attachment2_checkbox_for_deleting");
           if(attachment2_checkbox_for_deleting!=null&&attachment2_checkbox_for_deleting!="null"){
               if(attachment2_checkbox_for_deleting=='1'){
                   ...
                   $fileInput=$("#Soumu_news_attachment2_checkbox_for_deleting").parent().parent().prev().find('input[type="file"]').eq(0);
                  name=$fileInput.attr('name');
                  id=$fileInput.attr('id');
                  classAttr=$fileInput.attr('class');
                  ...
                  $fileInput.replaceWith("<input type='file' name='"+name+"' id='"+id+"' class='"+classAttr+"'/>");
                  //
                  $node1=$("#Soumu_news_attachment2_checkbox_for_deleting").parent().parent().prev().prev();
                  $node1.remove();
                  $('<img alt="" src="<?php echo $this->assetsBase; ?>/css/common/img/img_photo01.jpg">').insertBefore($("#Soumu_news_attachment2_checkbox_for_deleting").parent().parent().prev());
               }
               else{
           ...
           attachment3_checkbox_for_deleting=getCookie("soumu_news_edit_attachment3_checkbox_for_deleting");
           if(attachment3_checkbox_for_deleting!=null&&attachment3_checkbox_for_deleting!="null"){
               if(attachment3_checkbox_for_deleting=='1'){
                   ...
                   $fileInput=$("#Soumu_news_attachment3_checkbox_for_deleting").parent().parent().prev().find('input[type="file"]').eq(0);
                  name=$fileInput.attr('name');
                  id=$fileInput.attr('id');
                  classAttr=$fileInput.attr('class');
                  ...
                  $fileInput.replaceWith("<input type='file' name='"+name+"' id='"+id+"' class='"+classAttr+"'/>");
                  //
                  $node1=$("#Soumu_news_attachment3_checkbox_for_deleting").parent().parent().prev().prev();
                  $node1.remove();
                  $('<img alt="" src="<?php echo $this->assetsBase; ?>/css/common/img/img_photo01.jpg">').insertBefore($("#Soumu_news_attachment3_checkbox_for_deleting").parent().parent().prev());
               }
               else{
           ...
           setCookie("soumu_news_edit_content",content); 
        ...
        $('button[type="submit"]').click(function() {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "<?php echo Yii::app()->baseUrl; ?>/adminsoumu_news/edit/?id=<?php echo $model->id; ?>",
                data: jQuery('#soumu_news_form').serialize(),
                success: function(msg) {

                    jQuery('#soumu_news_form input[type="text"],#soumu_news_form textarea').prev().remove();
                    ...
                    if (msg != '[]' | checkFile() == false) {
                        ...
                        val=val.replace(/\n/g, "<br/>");
                        setCookie("soumu_news_edit_content",val);
                        if($("#Soumu_news_attachment1_checkbox_for_deleting").attr('checked')==true){
                            setCookie("soumu_news_edit_attachment1_checkbox_for_deleting",'1');
                        }
                        else{
                            setCookie("soumu_news_edit_attachment1_checkbox_for_deleting",'0');
                        }
                        if($("#Soumu_news_attachment2_checkbox_for_deleting").attr('checked')==true){
                            setCookie("soumu_news_edit_attachment2_checkbox_for_deleting",'1');
                        }
                        else{
                            setCookie("soumu_news_edit_attachment2_checkbox_for_deleting",'0');
                        }
                        if($("#Soumu_news_attachment3_checkbox_for_deleting").attr('checked')==true){
                            setCookie("soumu_news_edit_attachment3_checkbox_for_deleting",'1');
                        }
                        else{
                            setCookie("soumu_news_edit_attachment3_checkbox_for_deleting",'0');
                        }
