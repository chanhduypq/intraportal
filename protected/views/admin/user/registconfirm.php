...
<script type="text/javascript">
    jQuery(function($) {
        ...
        if ($('#User_photo_checkbox_for_deleting').parent().find('a').length == 0) {

            ck = $('#User_photo_checkbox_for_deleting').clone();            
            eye=$('#User_photo').clone();
            $("#user_form").append($(ck));
            $("#user_form").append($(eye));
            $('#User_photo_checkbox_for_deleting').parent().parent().remove();
        }
...
<div class="wrap admin secondary user">
    ...
    <div class="container">
        <div class="contents detail">
            ...
            <div class="mainBox">
                <div class="pageTtl"><h2>ユーザー管理 - 登録確認</h2></div>
                <div class="box">
                    <div class="cnt-box">
                        <?php
                        ...
                        <div class="baseDetailBox">
                            ...
                            <div class="textBox boxL mt15 clearfix">
                                ...
                                <div class="field ruby">
                                    ...
                                    <div class="data">
										<?php echo ($model->lastname_kana . ' ' . $model->firstname_kana);?>
									</div>
                                </div>
                            ...
                            <div class="textBox boxR clearfix">
                                ...
                                $attachements->registConfirm14($model, $form,'adminuser','photo',$this->assetsBase);
                                $this->endWidget();
                                    ?>                          
