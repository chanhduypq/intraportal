    ...
    <div class="container">
        <div class="contents detail">
            <div class="mainBox detail">
                <div class="pageTtl"><h2>役員宛目安箱 - 詳細</h2>
                    ...
                    <span><a class="btn btn-work" href="<?php echo Yii::app()->request->baseUrl; ?>/adminto_officer/edit/?id=<?php echo $model->id;?>"><i class="icon-pencil icon-white"></i> 修正</a></span>
                </div>
                <div class="box">
