    ...
    <div class="container">
        <div class="contents regist">
            ...
            <div class="mainBox detail">
            	<div class="pageTtl">
				<h2>趣味・サークルの広場What'sNew  - カテゴリー - 登録</h2>
                <span>
...
{         
	...
	{   
		...
		$.ajax({    
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/admincategory/categoryregist/?type=6",    
				data: jQuery('#hobby_new_cat_regist').serialize(),
				...
				{	     
					  ...
					  {   
							...
							if(r==true)
							{
								...
								//jQuery('#hobby_new_cat_regist').attr('onsubmit','return true;');
								jQuery('#hobby_new_cat_regist').submit();
							}
					  }					    			    
				 }	  
			});
