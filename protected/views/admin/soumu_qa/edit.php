    ...
    <div class="container">
        <div class="contents edit">
            ...
            <div class="mainBox detail">
            	<div class="pageTtl"><h2>教えて総務さん！FAQ - 修正</h2>
                 <?php 
					...
					?>
                <span><a class="btn btn-important" href="<?php echo Yii::app()->request->baseUrl; ?>/adminsoumu_qa/<?php echo $page; ?>"><i class="icon-chevron-left icon-white"></i> 一覧に戻る</a></span>
                </div>
                <div class="box">
                <?php
                ...
                <div class="cnt-box">
                  ...
                  <div class="field attachements">
                        ...
                        $attachements->edit11($model, $form,'adminsoumu_qa',$attachment1_error,$attachment2_error,$attachment3_error,$this->assetsBase);                        
                        $this->endWidget();
                        ?>
...
function checkId()
{
        ...
        type: "POST", 
                async:true,
                url: "<?php echo Yii::app()->baseUrl;?>/adminsoumu_qa/checkId/",    
                data:{id:"<?php echo $model->id;?>",table:"soumu_qa"},
                success: function(msg){	
            
                        
                        if(msg=='0'){ 
                                window.location='<?php echo Yii::app()->baseUrl;?>/adminsoumu_qa';
                        }
                }
        });
}
...
$('input[type="checkbox"]').click (function (){            
           ...
           $("#soumu_qa_form").attr('action', '<?php echo Yii::app()->baseUrl; ?>/adminsoumu_qa/editconfirm/');    
		   
		   category_id=getCookie("soumu_qa_edit_category_id");
           if(category_id!=null&&category_id!="null"){
               $("#Soumu_qa_category_id").val(category_id);
           }
		                   
           title=getCookie("soumu_qa_edit_title");
           ...
           content=getCookie("soumu_qa_edit_content");
           if(content!=null&&content!="null"){
              content1=content.replace(/<br ?\/?>|_/g, '\n');    
               $("#Soumu_qa_content").val(content1);
           }   
           attachment1_checkbox_for_deleting=getCookie("soumu_qa_edit_attachment1_checkbox_for_deleting");
           if(attachment1_checkbox_for_deleting!=null&&attachment1_checkbox_for_deleting!="null"){              
               if(attachment1_checkbox_for_deleting=='1'){
                   ...
                   $fileInput=$("#Soumu_qa_attachment1_checkbox_for_deleting").parent().parent().prev().find('input[type="file"]').eq(0);
                  name=$fileInput.attr('name');
                  id=$fileInput.attr('id');
                  classAttr=$fileInput.attr('class');
                  ...
                  $fileInput.replaceWith("<input type='file' name='"+name+"' id='"+id+"' class='"+classAttr+"'/>");
                  //
                  $node1=$("#Soumu_qa_attachment1_checkbox_for_deleting").parent().parent().prev().prev();
                  $node1.remove();
                  $('<img alt="" src="<?php echo $this->assetsBase; ?>/css/common/img/img_photo01.jpg">').insertBefore($("#Soumu_qa_attachment1_checkbox_for_deleting").parent().parent().prev());                      
               }
               else{
           ...
           attachment2_checkbox_for_deleting=getCookie("soumu_qa_edit_attachment2_checkbox_for_deleting");
           if(attachment2_checkbox_for_deleting!=null&&attachment2_checkbox_for_deleting!="null"){
               if(attachment2_checkbox_for_deleting=='1'){
                   ...
                   $fileInput=$("#Soumu_qa_attachment2_checkbox_for_deleting").parent().parent().prev().find('input[type="file"]').eq(0);
                  name=$fileInput.attr('name');
                  id=$fileInput.attr('id');
                  classAttr=$fileInput.attr('class');
                  ...
                  $fileInput.replaceWith("<input type='file' name='"+name+"' id='"+id+"' class='"+classAttr+"'/>");
                  //
                  $node1=$("#Soumu_qa_attachment2_checkbox_for_deleting").parent().parent().prev().prev();
                  $node1.remove();
                  $('<img alt="" src="<?php echo $this->assetsBase; ?>/css/common/img/img_photo01.jpg">').insertBefore($("#Soumu_qa_attachment2_checkbox_for_deleting").parent().parent().prev());                      
               }
               else{
           ...
           attachment3_checkbox_for_deleting=getCookie("soumu_qa_edit_attachment3_checkbox_for_deleting");
           if(attachment3_checkbox_for_deleting!=null&&attachment3_checkbox_for_deleting!="null"){
               if(attachment3_checkbox_for_deleting=='1'){
                   ...
                   $fileInput=$("#Soumu_qa_attachment3_checkbox_for_deleting").parent().parent().prev().find('input[type="file"]').eq(0);
                  name=$fileInput.attr('name');
                  id=$fileInput.attr('id');
                  classAttr=$fileInput.attr('class');
                  ...
                  $fileInput.replaceWith("<input type='file' name='"+name+"' id='"+id+"' class='"+classAttr+"'/>");
                  //
                  $node1=$("#Soumu_qa_attachment3_checkbox_for_deleting").parent().parent().prev().prev();
                  $node1.remove();
                  $('<img alt="" src="<?php echo $this->assetsBase; ?>/css/common/img/img_photo01.jpg">').insertBefore($("#Soumu_qa_attachment3_checkbox_for_deleting").parent().parent().prev());                      
               }
               else{
		  ...
		  setCookie("soumu_qa_edit_category_id",$("#Soumu_qa_category_id").val());
           setCookie("soumu_qa_edit_title",$("#Soumu_qa_title").val());
           setCookie("soumu_qa_edit_content",content);
           ...
           $('button[type="submit"]').click(function(){  
			...
			$.ajax({ 
				...
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/adminsoumu_qa/edit/?id=<?php echo $model->id;?>",    
				...
				success: function(msg){	                        
					  ...
					  jQuery('#Soumu_qa_content').prev().remove();                                       					
					  	if(msg!='[]'|checkFile()==false){
                                            ...
                                            val=val.replace(/\n/g, "<br/>");
                                            setCookie("soumu_qa_edit_content",val);
                                            if($("#Soumu_qa_attachment1_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("soumu_qa_edit_attachment1_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("soumu_qa_edit_attachment1_checkbox_for_deleting",'0');
                                                }
                                                if($("#Soumu_qa_attachment2_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("soumu_qa_edit_attachment2_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("soumu_qa_edit_attachment2_checkbox_for_deleting",'0');
                                                }
                                                if($("#Soumu_qa_attachment3_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("soumu_qa_edit_attachment3_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("soumu_qa_edit_attachment3_checkbox_for_deleting",'0');
                                                }
