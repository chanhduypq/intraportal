    ...
    <div class="container">
        <div class="contents regist">        	
            <div class="mainBox detail">            	
                <div class="pageTtl"><h2>趣味・サークル広場サークル紹介 - 登録</h2>
                    <span><a class="btn btn-important" href="<?php echo Yii::app()->baseUrl;?>/asobihobby_itd/index"><i class="icon-chevron-left icon-white"></i> 一覧に戻る</a></span>
                </div>
                <div class="box">
                <?php
                ...
                <div class="cnt-box">      
                    <div class="control-group">
                        ...
                        $attachement4 = $this->beginWidget('ext.helpers.Form_new');
                            $attachement4->regist14($model, $form,$attachment4_error,'asobihobby_itd',$this->assetsBase);
                            $this->endWidget();
                            ?>
                  ...
                  <div class="field attachements">
                      ...
                      <?php                 
					    ...
					    $attachements->regist11($model, $form,$attachment1_error,$attachment2_error,$attachment3_error,'asobihobby_itd',$this->assetsBase);
                        $this->endWidget();
                    ?>
...
<script type="text/javascript">  
        ...
        $('input[type="checkbox"]').click (function (){            
           ...
           $("#hobby_itd_form").attr('action','<?php echo Yii::app()->baseUrl;?>/asobihobby_itd/registconfirm/');          
           title=getCookie("hobby_itd_regist_title");          
           ...
           content=getCookie("hobby_itd_regist_content");           
           if(content!=null&&content!="null"){
               content1=content.replace(/<br ?\/?>|_/g, '\n');
               $("#Hobby_itd_content").val(content1);
           }
          
           attachment1_checkbox_for_deleting=getCookie("hobby_itd_regist_attachment1_checkbox_for_deleting");
           ...
           attachment2_checkbox_for_deleting=getCookie("hobby_itd_regist_attachment2_checkbox_for_deleting");
           ...
           attachment3_checkbox_for_deleting=getCookie("hobby_itd_regist_attachment3_checkbox_for_deleting");
           ...
           eye_catch_checkbox_for_deleting=getCookie("hobby_itd_regist_eye_catch_checkbox_for_deleting");
           ...
           setCookie("hobby_itd_regist_content",content); 
            /**
             * 
             */
           $("body").attr('id','asobi');    
           ...
           $('button[type="submit"]').click(function(){  
			...
			$.ajax({    
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/asobihobby_itd/regist/",    
				...
				success: function(msg){	                        					  		
					  ...
					  jQuery('#Hobby_itd_content').prev().remove();           
					  	if(msg!='[]'|checkFile()==false){
                                                ...
                                                val=val.replace(/\n/g, "<br/>");
                                                setCookie("hobby_itd_regist_content",val);
                                                
                                                if($("#Hobby_itd_attachment1_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("hobby_itd_regist_attachment1_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("hobby_itd_regist_attachment1_checkbox_for_deleting",'0');
                                                }
                                                if($("#Hobby_itd_attachment2_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("hobby_itd_regist_attachment2_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("hobby_itd_regist_attachment2_checkbox_for_deleting",'0');
                                                }
                                                if($("#Hobby_itd_attachment3_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("hobby_itd_regist_attachment3_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("hobby_itd_regist_attachment3_checkbox_for_deleting",'0');
                                                }
                                                if($("#Hobby_itd_eye_catch_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("hobby_itd_regist_eye_catch_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("hobby_itd_regist_eye_catch_checkbox_for_deleting",'0');
                                                }
