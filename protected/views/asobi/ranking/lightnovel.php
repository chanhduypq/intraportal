...
<div class="wrap asobi secondary ranking">
    ...
    <div class="container">
        <div class="contents animation index">
            ...
            <div class="mainBox">
            	<div class="pageTtl">
					<h2>ライトノベルジャンル　<?php echo substr($yearmonth, 0, 4);?>年<?php echo substr($yearmonth, 4, 2);?>月最新ランキング</h2>
                ...
                <div class="box">
					...
					<p class="descriptionTxt">オリコン集計によライトノベルジャンル　<?php echo substr($yearmonth, 0, 4);?>年<?php echo substr($yearmonth, 4, 2);?>月最新ランキングです。</p>
							...
							<tr>
	                			...
	                			<td class="td-iteminfo">
	                				...
	                				<ul class="info">
	                					...
	                					<li class="price">税込価格：
											<?php echo isset($item[7]) ? $item[7] :null;?>円
										</li>
	                				</ul>
	                			</td>
                			</tr>
