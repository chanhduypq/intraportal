...
<div class="wrap asobi secondary ranking">
    ...
    <div class="container">
        <div class="contents animation index">
            ...
            <div class="mainBox">
            	<div class="pageTtl">
					<h2>コミックジャンル　<?php echo substr($yearmonth, 0, 4);?>年<?php echo substr($yearmonth, 4, 2);?>月最新ランキング</h2>
					<a href="<?php echo Yii::app()->baseUrl?>/asobi" class="btn btn-important">
						<i class="icon-home icon-white"></i> あそびのTopへ戻る</a>
				</div>
                <div class="box">
                	...
                	<p class="descriptionTxt">オリコン集計によるコミックジャンル　<?php echo substr($yearmonth, 0, 4);?>年<?php echo substr($yearmonth, 4, 2);?>月最新ランキングです。</p>
                		...
                		<tbody>
							...
							<tr>
	                			...
	                			<td class="td-iteminfo">
                					<p class="title">
										<a href="http://www.amazon.co.jp/s/ref=nb_sb_noss?__mk_ja_JP=カタカナ&url=search-alias%3Daps&field-keywords=<?php echo $item[3]?>" target="_blank">
											<?php echo isset($item[3]) ? $item[3] :null;?>
										</a>
									</p>
	                				<ul class="info">
	                					<li class="artist">著者名：<?php echo isset($item[4]) ? $item[4] :null;?></li>
	                					<li class="sale_agen">出版社：<?php echo isset($item[5]) ? $item[5] :null;?></li>
	                					<li class="sale_date">発売年月：<?php echo isset($item[6]) ? formatDate($item[6]) :null;?></li>
	                					<li class="price">税込価格：<?php echo isset($item[7]) ? $item[7] :null;?>円</li>
	                				</ul>
	                			</td>
                			</tr>
							<?php endif;?>
