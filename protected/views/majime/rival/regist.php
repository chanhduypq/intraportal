            ...
            <div class="mainBox detail">
            	<div class="pageTtl">
                    ...
                    <?php
						 ...
						 {
					  ?>
						<a class="btn btn-important" href="<?php echo Yii::app()->request->baseUrl; ?>/majimerival/index">
                    ...
                    <div class="control-group">
                      ...
                      <div class="field attachements">
                        <?php                 
                            ...
                            $attachements->regist11($model, $form,$attachment1_error,$attachment2_error,$attachment3_error,'majimerival',$this->assetsBase);
                            $this->endWidget();
                        ?>
...
<script type="text/javascript"> 
        ...
        $('input[type="checkbox"]').click (function (){            
           ...
           $("#rival_form").attr('action','<?php echo Yii::app()->baseUrl;?>/majimerival/registconfirm/');          
           title=getCookie("rival_regist_title");
           ...
           content=getCookie("rival_regist_content");           
           if(content!=null&&content!="null"){
			   content1=content.replace(/<br\s*\/?>|_/mg,"\n");        
               $("#Rival_content").val(content1);
           }
           attachment1_checkbox_for_deleting=getCookie("rival_regist_attachment1_checkbox_for_deleting");
           ...
           attachment2_checkbox_for_deleting=getCookie("rival_regist_attachment2_checkbox_for_deleting");
           ...
           attachment3_checkbox_for_deleting=getCookie("rival_regist_attachment3_checkbox_for_deleting");
           ...
           setCookie("rival_regist_content",content); 
            /**
             * 
             */
           $("body").attr('id','majime');      
           ...
           $('button[type="submit"]').click(function(){  
			...
			$.ajax({    
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/majimerival/regist/",    
				...
				success: function(msg){	                        					  		
					  ...
					  jQuery('#Rival_content').prev().remove();                                       						                                            					  	
					  	if(msg!='[]'|checkFile()==false){
                                                ...
                                                val=val.replace(/\n/g, "<br/>");
                                                setCookie("rival_regist_content",val);
                                                if($("#Rival_attachment1_checkbox_for_deleting").attr('checked')==true)
												{
                                                    setCookie("rival_regist_attachment1_checkbox_for_deleting",'1');
                                                }
                                                else
												{
                                                    setCookie("rival_regist_attachment1_checkbox_for_deleting",'0');
                                                }
                                                if($("#Rival_attachment2_checkbox_for_deleting").attr('checked')==true)
												{
                                                    setCookie("rival_regist_attachment2_checkbox_for_deleting",'1');
                                                }
                                                else
												{
                                                    setCookie("rival_regist_attachment2_checkbox_for_deleting",'0');
                                                }
                                                if($("#Rival_attachment3_checkbox_for_deleting").attr('checked')==true)
												{
                                                    setCookie("rival_regist_attachment3_checkbox_for_deleting",'1');
                                                }
                                                else
												{
                                                    setCookie("rival_regist_attachment3_checkbox_for_deleting",'0');
                                                }
