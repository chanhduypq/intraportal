            	...
            	<div class="pageTtl">
                    ...
                    <span>
                      <?php
						 ...
						 {
					  ?>
						<a class="btn btn-important" href="<?php echo Yii::app()->request->baseUrl; ?>/majimetrouble/index">
                ...
                <div class="cnt-box">                    
                   ...
                   <div class="field attachements">
                        ...
                        $attachements = $this->beginWidget('ext.helpers.Form_new');
                            $attachements->regist11($model, $form,$attachment1_error,$attachment2_error,$attachment3_error,'majimetrouble',$this->assetsBase);
                            $this->endWidget();
                            ?>
...
<script type="text/javascript">  
        ...
        jQuery(function($){
           ...
           $("#trouble_form").attr('action','<?php echo Yii::app()->baseUrl;?>/majimetrouble/registconfirm/');
           title=getCookie("trouble_regist_title");
           ...
           content=getCookie("trouble_regist_content");
           if(content!=null&&content!="null"){
               
               content1=content.replace(/<br ?\/?>|_/g, '\n');
               $("#Trouble_content").val(content1);
           }
           attachment1_checkbox_for_deleting=getCookie("trouble_regist_attachment1_checkbox_for_deleting");
           ...
           attachment2_checkbox_for_deleting=getCookie("trouble_regist_attachment2_checkbox_for_deleting");
           ...
           attachment3_checkbox_for_deleting=getCookie("trouble_regist_attachment3_checkbox_for_deleting");
           ...
           setCookie("trouble_regist_content",content);       
            /**
             * 
             */
           $("body").attr('id','majime');      
           ...
           $('button[type="submit"]').click(function(){ 
			...
			$.ajax({    
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/majimetrouble/regist/",    
				data: jQuery('#trouble_form').serialize(),
				success: function(msg){	                        					  		
					  jQuery('#trouble_form input,#trouble_form textarea').prev().remove();                                       						                                            					  	
					  	if(msg!='[]'|checkFile()==false){
                                            ...
                                            val=val.replace(/\n/g, "<br/>");
                                            setCookie("trouble_regist_content",val);  
                                            if($("#Trouble_attachment1_checkbox_for_deleting").attr('checked')==true){
                                                setCookie("trouble_regist_attachment1_checkbox_for_deleting",'1');
                                            }
                                            else{
                                                setCookie("trouble_regist_attachment1_checkbox_for_deleting",'0');
                                            }
                                            if($("#Trouble_attachment2_checkbox_for_deleting").attr('checked')==true){
                                                setCookie("trouble_regist_attachment2_checkbox_for_deleting",'1');
                                            }
                                            else{
                                                setCookie("trouble_regist_attachment2_checkbox_for_deleting",'0');
                                            }
                                            if($("#Trouble_attachment3_checkbox_for_deleting").attr('checked')==true){
                                                setCookie("trouble_regist_attachment3_checkbox_for_deleting",'1');
                                            }
                                            else{
                                                setCookie("trouble_regist_attachment3_checkbox_for_deleting",'0');
                                            }
