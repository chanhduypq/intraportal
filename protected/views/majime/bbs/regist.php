            	...
            	<div class="pageTtl">
                    ...
                    <span>
                     <?php
						 ...
						 {
					 ?>
				        <a class="btn btn-important" href="<?php echo Yii::app()->request->baseUrl; ?>/majimebbs">
                    ...
                    <div class="control-group">
                      ...
                      <div class="field attachements">
                        <?php                 
                            ...
                            $attachements->regist11($model, $form,$attachment1_error,$attachment2_error,$attachment3_error,'majimebbs',$this->assetsBase);
                            $this->endWidget();
                        ?>
...
<script type="text/javascript"> 
        ...
        $('input[type="checkbox"]').click (function (){            
           ...
           $("#bbs_form").attr('action','<?php echo Yii::app()->baseUrl;?>/majimebbs/registconfirm/');          
           title=getCookie("bbs_regist_title");
           ...
           content=getCookie("bbs_regist_content");           
           if(content!=null&&content!="null"){
              content1=content.replace(/<br ?\/?>|_/g, '\n');    
               $("#Bbs_content").val(content1);
           }
           attachment1_checkbox_for_deleting=getCookie("bbs_regist_attachment1_checkbox_for_deleting");
           ...
           attachment2_checkbox_for_deleting=getCookie("bbs_regist_attachment2_checkbox_for_deleting");
           ...
           attachment3_checkbox_for_deleting=getCookie("bbs_regist_attachment3_checkbox_for_deleting");
           ...
           setCookie("bbs_regist_content",content); 
            /**
             * 
             */
           $("body").attr('id','majime');      
           ...
           $('button[type="submit"]').click(function(){  
			...
			$.ajax({    
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/majimebbs/regist/",    
				...
				success: function(msg){	                        					  		
					  ...
					  jQuery('#Bbs_content').prev().remove();                                       						                                            					  	
					  	if(msg!='[]'|checkFile()==false){
                                                ...
                                                val=$("#Bbs_content").val();
                                                val=val.replace(/\n/g, "<br/>");
                                                setCookie("bbs_regist_content",val);
                                                if($("#Bbs_attachment1_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("bbs_regist_attachment1_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("bbs_regist_attachment1_checkbox_for_deleting",'0');
                                                }
                                                if($("#Bbs_attachment2_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("bbs_regist_attachment2_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("bbs_regist_attachment2_checkbox_for_deleting",'0');
                                                }
                                                if($("#Bbs_attachment3_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("bbs_regist_attachment3_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("bbs_regist_attachment3_checkbox_for_deleting",'0');
                                                }
