            ...
            <div class="mainBox detail">
            	<div class="pageTtl">
                    ...
                    <?php
						 ...
						 {
					?>
                        <a class="btn btn-important" href="<?php echo Yii::app()->request->baseUrl; ?>/majimeto_officer/">
                ...
                <div class="cnt-box">                    
                  ...
                  <div class="field attachements">
                        ...
                        $attachements = $this->beginWidget('ext.helpers.Form_new');
                            $attachements->regist11($model, $form,$attachment1_error,$attachment2_error,$attachment3_error,'majimeto_officer',$this->assetsBase);
                            $this->endWidget();
                            ?>
...
<script type="text/javascript">
        ...
        jQuery(function($){   
            $("#toofficer_form").attr('action','<?php echo Yii::app()->baseUrl;?>/majimeto_officer/addconfirm/');    
        $('input[type="checkbox"]').click (function (){            
            ...
            title=getCookie("to_officer_add_title");
           ...
           content=getCookie("to_officer_add_content");
           if(content!=null&&content!="null"){
               
               content1=content.replace(/<br ?\/?>|_/g, '\n');         
               $("#Toofficer_content").val(content1);
           }
           attachment1_checkbox_for_deleting=getCookie("to_officer_add_attachment1_checkbox_for_deleting");
           ...
           attachment2_checkbox_for_deleting=getCookie("to_officer_add_attachment2_checkbox_for_deleting");
           ...
           attachment3_checkbox_for_deleting=getCookie("to_officer_add_attachment3_checkbox_for_deleting");
           ...
           setCookie("to_officer_add_content",content); 
           ...
           $('button[type="submit"]').click(function(){ 
			...
			$.ajax({    
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/majimeto_officer/add/",    
				data: jQuery('#toofficer_form').serialize(),
				success: function(msg){	                        					  		
					  jQuery('#toofficer_form input,#toofficer_form select,#toofficer_form textarea').prev().remove();                                       						                                            					  	
					  	if(msg!='[]'|checkFile()==false){
                                                    data=$.parseJSON(msg);
                                                    if(data.Toofficer_title){
                                            ...
                                            val=val.replace(/\n/g, "<br/>");
                                            setCookie("to_officer_add_content",val);  
                                            
                                            if($("#Toofficer_attachment1_checkbox_for_deleting").attr('checked')==true){
                                                setCookie("to_officer_add_attachment1_checkbox_for_deleting",'1');
                                            }
                                            else{
                                                setCookie("to_officer_add_attachment1_checkbox_for_deleting",'0');
                                            }
                                            if($("#Toofficer_attachment2_checkbox_for_deleting").attr('checked')==true){
                                                setCookie("to_officer_add_attachment2_checkbox_for_deleting",'1');
                                            }
                                            else{
                                                setCookie("to_officer_add_attachment2_checkbox_for_deleting",'0');
                                            }
                                            if($("#Toofficer_attachment3_checkbox_for_deleting").attr('checked')==true){
                                                setCookie("to_officer_add_attachment3_checkbox_for_deleting",'1');
                                            }
                                            else{
                                                setCookie("to_officer_add_attachment3_checkbox_for_deleting",'0');
                                            }
