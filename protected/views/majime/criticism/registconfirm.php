    ...
    <div class="container">
        <div class="contents confirm">
            ...
            <div class="mainBox detail">
            	<div class="pageTtl"><h2>機種総評＆検証 - 登録 確認</h2></div>
                <div class="box">
                <?php
				$form = $this->beginWidget('CActiveForm', array(
					'id' => 'criticism_form',    
					'htmlOptions' => array('enctype' => 'multipart/form-data','action'=>Yii::app()->baseUrl.'/majimecriticism/registconfirm'),
						));
				?> 
                    ...
                    <div class="cnt-box">
                        ...
                        <div class="field attachements">
                            <?php                    
                                ...
                                $attachements->registConfirm11($model, $form,'majimecriticism',$this->assetsBase);
                                $this->endWidget();
...
<script type="text/javascript">
    jQuery(function($) { 
        ...
        $(window).on('beforeunload', function(){
            setCookie1("criticism_regist_from","confirm");            
        ...
        setCookie1("criticism_regist_content",$("#Criticism_content").val());
        setCookie1("criticism_regist_attachment1_checkbox_for_deleting",$("#Criticism_attachment1_checkbox_for_deleting").val());
        setCookie1("criticism_regist_attachment2_checkbox_for_deleting",$("#Criticism_attachment2_checkbox_for_deleting").val());
        setCookie1("criticism_regist_attachment3_checkbox_for_deleting",$("#Criticism_attachment3_checkbox_for_deleting").val());
        ...
        $('button#back').click(function(){  
            ...
            window.location="<?php echo Yii::app()->baseUrl;?>/majimecriticism/regist/";
        });
        $('a').click(function(){  
            img=$(this).find('img');
