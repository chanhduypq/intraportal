            	...
            	<div class="pageTtl">
                    ...
                    <span>
                    	<?php
							 ...
							 {
						 ?>
							<a class="btn btn-important" href="<?php echo Yii::app()->request->baseUrl; ?>/majimeclaim/index">
                ...
                <div class="cnt-box">                    
                  ...
                  <div class="field attachements">
                    <?php
                        ...
                        $attachements->regist11($model, $form,$attachment1_error,$attachment2_error,$attachment3_error,'majimeclaim',$this->assetsBase);
                        $this->endWidget();
                    ?>
...
<script type="text/javascript">  
        ...
        jQuery(function($){ 
           ...
           $("#claim_form").attr('action','<?php echo Yii::app()->baseUrl;?>/majimeclaim/registconfirm/');          
           title=getCookie("claim_regist_title");
           ...
           content=getCookie("claim_regist_content");
           ...
           attachment1_checkbox_for_deleting=getCookie("claim_regist_attachment1_checkbox_for_deleting");
           ...
           attachment2_checkbox_for_deleting=getCookie("claim_regist_attachment2_checkbox_for_deleting");
           ...
           attachment3_checkbox_for_deleting=getCookie("claim_regist_attachment3_checkbox_for_deleting");
           ...
           setCookie("claim_regist_content",content); 
...
$('a').click(function(){ 
           ...
           $('button[type="submit"]').click(function(){  
			...
			$.ajax({    
				type: "POST", 
				async:true,
				url: "<?php echo Yii::app()->baseUrl;?>/majimeclaim/regist/",    
				...
				success: function(msg){	                        					  		
					  ...
					  jQuery('#Claim_content').prev().remove();                                       						                                            					  	
					  	if(msg!='[]'|checkFile()==false){
                                                ...
                                                val=val.replace(/\n/g, "<br/>");
                                                setCookie("claim_regist_content",val);
                                                
                                                if($("#Claim_attachment1_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("claim_regist_attachment1_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("claim_regist_attachment1_checkbox_for_deleting",'0');
                                                }
                                                if($("#Claim_attachment2_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("claim_regist_attachment2_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("claim_regist_attachment2_checkbox_for_deleting",'0');
                                                }
                                                if($("#Claim_attachment3_checkbox_for_deleting").attr('checked')==true){
                                                    setCookie("claim_regist_attachment3_checkbox_for_deleting",'1');
                                                }
                                                else{
                                                    setCookie("claim_regist_attachment3_checkbox_for_deleting",'0');
                                                }
