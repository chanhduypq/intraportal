...
class Criticism extends CActiveRecord {
    ...
    public function beforeSave() {
        ...
        if ($this->getIsNewRecord() == true) {
            if (Yii::app()->request->cookies['file_criticism_regist_attachment1'] != "" && Yii::app()->request->cookies['file_criticism_regist_attachment1'] != "null") {
                $this->attachment1 = Yii::app()->request->cookies['file_criticism_regist_attachment1']->value;
            } else {
                $this->attachment1 = '';
            }
            if (Yii::app()->request->cookies['file_criticism_regist_attachment2'] != "" && Yii::app()->request->cookies['file_criticism_regist_attachment2'] != "null") {
                $this->attachment2 = Yii::app()->request->cookies['file_criticism_regist_attachment2']->value;
            } else {
                $this->attachment2 = '';
            }
            if (Yii::app()->request->cookies['file_criticism_regist_attachment3'] != "" && Yii::app()->request->cookies['file_criticism_regist_attachment3'] != "null") {
            ...
            if (Yii::app()->request->cookies['file_criticism_edit_attachment1'] != "" && Yii::app()->request->cookies['file_criticism_edit_attachment1'] != "null") {
                $this->attachment1 = Yii::app()->request->cookies['file_criticism_edit_attachment1']->value;
            }

            if (Yii::app()->request->cookies['file_criticism_edit_attachment2'] != "" && Yii::app()->request->cookies['file_criticism_edit_attachment2'] != "null") {
                $this->attachment2 = Yii::app()->request->cookies['file_criticism_edit_attachment2']->value;
            }

            if (Yii::app()->request->cookies['file_criticism_edit_attachment3'] != "" && Yii::app()->request->cookies['file_criticism_edit_attachment3'] != "null") {
