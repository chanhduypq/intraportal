...
class Pride extends CActiveRecord {
     ...
     * @return pride the static model class
     */
    ...
    public function rules() {
        return array(
            ...
            array('icon', 'required', 'message' => Lang::MSG_0009),
    ...
    public function beforeSave() {
        ...
        if ($this->getIsNewRecord() == true) {
            if (Yii::app()->request->cookies['file_pride_regist_attachment1'] != "" && Yii::app()->request->cookies['file_pride_regist_attachment1'] != "null") {
                $this->attachment1 = Yii::app()->request->cookies['file_pride_regist_attachment1']->value;
            } else {
                $this->attachment1 = '';
            }
            if (Yii::app()->request->cookies['file_pride_regist_attachment2'] != "" && Yii::app()->request->cookies['file_pride_regist_attachment2'] != "null") {
                $this->attachment2 = Yii::app()->request->cookies['file_pride_regist_attachment2']->value;
            } else {
                $this->attachment2 = '';
            }
            if (Yii::app()->request->cookies['file_pride_regist_attachment3'] != "" && Yii::app()->request->cookies['file_pride_regist_attachment3'] != "null") {
                $this->attachment3 = Yii::app()->request->cookies['file_pride_regist_attachment3']->value;
            } else {
                $this->attachment3 = '';
            }
            unset(Yii::app()->request->cookies['file_pride_regist_attachment1']);
            unset(Yii::app()->request->cookies['file_pride_regist_attachment2']);
            unset(Yii::app()->request->cookies['file_pride_regist_attachment3']);
        } else {
            if (Yii::app()->request->cookies['file_pride_edit_attachment1'] != "" && Yii::app()->request->cookies['file_pride_edit_attachment1'] != "null") {
                $this->attachment1 = Yii::app()->request->cookies['file_pride_edit_attachment1']->value;
            }

            if (Yii::app()->request->cookies['file_pride_edit_attachment2'] != "" && Yii::app()->request->cookies['file_pride_edit_attachment2'] != "null") {
                $this->attachment2 = Yii::app()->request->cookies['file_pride_edit_attachment2']->value;
            }

            if (Yii::app()->request->cookies['file_pride_edit_attachment3'] != "" && Yii::app()->request->cookies['file_pride_edit_attachment3'] != "null") {
                $this->attachment3 = Yii::app()->request->cookies['file_pride_edit_attachment3']->value;
            }
            unset(Yii::app()->request->cookies['file_pride_edit_attachment1']);
            unset(Yii::app()->request->cookies['file_pride_edit_attachment2']);
            unset(Yii::app()->request->cookies['file_pride_edit_attachment3']);

            /**
             * process attachment1
             */
            $attachment1 = Upload_file_common::getAttachmentById($this->id, 1, 'pride');
             ...
             * process attachment2
             */
            $attachment2 = Upload_file_common::getAttachmentById($this->id, 2, 'pride');
             ...
             * process attachment3
             */
            $attachment3 = Upload_file_common::getAttachmentById($this->id, 3, 'pride');
    ...
    /**
     *  save comment table pride comment
     */
    public function savePride_comment($pride_comment) {

        $pride_comment->pride_id = $this->id;
        $pride_comment->contributor_id = $_POST['contributor_id'];
        $pride_comment->comment = $this->trimStartAndTrimEnd($pride_comment->comment);
        $pride_comment->valuation = $this->trimStartAndTrimEnd($pride_comment->valuation);
        $pride_comment->created_date = FunctionCommon::getDateTimeSys();
        $pride_comment->last_updated_date = FunctionCommon::getDateTimeSys();
        ;
        $pride_comment->last_updated_person = FunctionCommon::getEmplNum();
        return $pride_comment->save();
    }
