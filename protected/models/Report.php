...
class Report extends CActiveRecord {
    ...
    public function saveReport_response($report_response) {
        $now = FunctionCommon::getDateTimeSys();
        $report_response->report_id = $this->id;
        $report_response->contributor_id = Yii::app()->request->cookies['id'];
        ;
        $report_response->content =trim($report_response->content);
        $report_response->created_date = $now;
        $report_response->last_updated_date = $now;
        $report_response->last_updated_person = FunctionCommon::getEmplNum();
        return $report_response->save();
    }
    ...
    public function beforeSave() {
        ...
        if ($this->getIsNewRecord() == true) {
            if (Yii::app()->request->cookies['file_report_regist_attachment1'] != "" && Yii::app()->request->cookies['file_report_regist_attachment1'] != "null") {
                $this->attachment1 = Yii::app()->request->cookies['file_report_regist_attachment1']->value;
            } else {
                $this->attachment1 = '';
            }
            if (Yii::app()->request->cookies['file_report_regist_attachment2'] != "" && Yii::app()->request->cookies['file_report_regist_attachment2'] != "null") {
                $this->attachment2 = Yii::app()->request->cookies['file_report_regist_attachment2']->value;
            } else {
                $this->attachment2 = '';
            }
            if (Yii::app()->request->cookies['file_report_regist_attachment3'] != "" && Yii::app()->request->cookies['file_report_regist_attachment3'] != "null") {
                $this->attachment3 = Yii::app()->request->cookies['file_report_regist_attachment3']->value;
            } else {
                $this->attachment3 = '';
            }
            unset(Yii::app()->request->cookies['file_report_regist_attachment1']);
            unset(Yii::app()->request->cookies['file_report_regist_attachment2']);
            unset(Yii::app()->request->cookies['file_report_regist_attachment3']);
        } else {
            if (Yii::app()->request->cookies['file_report_edit_attachment1'] != "" && Yii::app()->request->cookies['file_report_edit_attachment1'] != "null") {
                $this->attachment1 = Yii::app()->request->cookies['file_report_edit_attachment1']->value;
            }

            if (Yii::app()->request->cookies['file_report_edit_attachment2'] != "" && Yii::app()->request->cookies['file_report_edit_attachment2'] != "null") {
                $this->attachment2 = Yii::app()->request->cookies['file_report_edit_attachment2']->value;
            }

            if (Yii::app()->request->cookies['file_report_edit_attachment3'] != "" && Yii::app()->request->cookies['file_report_edit_attachment3'] != "null") {
                $this->attachment3 = Yii::app()->request->cookies['file_report_edit_attachment3']->value;
            }
            unset(Yii::app()->request->cookies['file_report_edit_attachment1']);
            unset(Yii::app()->request->cookies['file_report_edit_attachment2']);
            unset(Yii::app()->request->cookies['file_report_edit_attachment3']);

            /**
             * process attachment1
             */
            $attachment1 = Upload_file_common::getAttachmentById($this->id, 1, 'report');
             ...
             * process attachment2
             */
            $attachment2 = Upload_file_common::getAttachmentById($this->id, 2, 'report');
             ...
             * process attachment3
             */
            $attachment3 = Upload_file_common::getAttachmentById($this->id, 3, 'report');
