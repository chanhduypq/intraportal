...
class Hobby_itd extends CActiveRecord {
    ...
    public function beforeSave() {
        ...
        if ($this->getIsNewRecord() == true) {
            if (Yii::app()->request->cookies['file_hobby_itd_regist_attachment1'] != "" && Yii::app()->request->cookies['file_hobby_itd_regist_attachment1'] != "null") {
                $this->attachment1 = Yii::app()->request->cookies['file_hobby_itd_regist_attachment1']->value;
            } else {
                $this->attachment1 = '';
            }
            if (Yii::app()->request->cookies['file_hobby_itd_regist_attachment2'] != "" && Yii::app()->request->cookies['file_hobby_itd_regist_attachment2'] != "null") {
                $this->attachment2 = Yii::app()->request->cookies['file_hobby_itd_regist_attachment2']->value;
            } else {
                $this->attachment2 = '';
            }
            if (Yii::app()->request->cookies['file_hobby_itd_regist_attachment3'] != "" && Yii::app()->request->cookies['file_hobby_itd_regist_attachment3'] != "null") {
                $this->attachment3 = Yii::app()->request->cookies['file_hobby_itd_regist_attachment3']->value;
            } else {
                $this->attachment3 = '';
            }
            if (Yii::app()->request->cookies['file_hobby_itd_regist_attachment4'] != "" && Yii::app()->request->cookies['file_hobby_itd_regist_attachment4'] != "null") {
                $this->eye_catch = Yii::app()->request->cookies['file_hobby_itd_regist_attachment4']->value;
            } else {
                $this->eye_catch = '';
            }
            unset(Yii::app()->request->cookies['file_hobby_itd_regist_attachment1']);
            unset(Yii::app()->request->cookies['file_hobby_itd_regist_attachment2']);
            unset(Yii::app()->request->cookies['file_hobby_itd_regist_attachment3']);
            unset(Yii::app()->request->cookies['file_hobby_itd_regist_attachment4']);
        } else {
            if (Yii::app()->request->cookies['file_hobby_itd_edit_attachment1'] != "" && Yii::app()->request->cookies['file_hobby_itd_edit_attachment1'] != "null") {
                $this->attachment1 = Yii::app()->request->cookies['file_hobby_itd_edit_attachment1']->value;
            }

            if (Yii::app()->request->cookies['file_hobby_itd_edit_attachment2'] != "" && Yii::app()->request->cookies['file_hobby_itd_edit_attachment2'] != "null") {
                $this->attachment2 = Yii::app()->request->cookies['file_hobby_itd_edit_attachment2']->value;
            }

            if (Yii::app()->request->cookies['file_hobby_itd_edit_attachment3'] != "" && Yii::app()->request->cookies['file_hobby_itd_edit_attachment3'] != "null") {
                $this->attachment3 = Yii::app()->request->cookies['file_hobby_itd_edit_attachment3']->value;
            }
            if (Yii::app()->request->cookies['file_hobby_itd_edit_attachment4'] != "" && Yii::app()->request->cookies['file_hobby_itd_edit_attachment4'] != "null") {
                $this->eye_catch = Yii::app()->request->cookies['file_hobby_itd_edit_attachment4']->value;
            }
            unset(Yii::app()->request->cookies['file_hobby_itd_edit_attachment1']);
            unset(Yii::app()->request->cookies['file_hobby_itd_edit_attachment2']);
            unset(Yii::app()->request->cookies['file_hobby_itd_edit_attachment3']);
            unset(Yii::app()->request->cookies['file_hobby_itd_edit_attachment4']);
            //eye_catch

            /**
             * process attachment1
             */
            $attachment1 = Upload_file_common::getAttachmentById($this->id, 1, 'hobby_itd');
             ...
             * process attachment2
             */
            $attachment2 = Upload_file_common::getAttachmentById($this->id, 2, 'hobby_itd');
             ...
             * process attachment3
             */
            $attachment3 = Upload_file_common::getAttachmentById($this->id, 3, 'hobby_itd');
            ...
            $eye_catch = $this->getEyeCatchById($this->id);
    ...
    public function getEyeCatchById($id) {
